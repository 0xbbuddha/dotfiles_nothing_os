...
Singleton {
    ...
    readonly property var entries: [
        ...
        { key: "windowLayout", label: "Window layout",  page: 1, words: "layout tiling scrolling essential dwindle niri paperwm columns tape shelf windows arrange", icon: "󰜨" },
        ...
        { key: "shelfSide", label: "Shelf side",  page: 1, words: "essential layout shelf side left right parked windows", icon: "󰕰" },
        { key: "mainWidth", label: "Main pane",   page: 1, words: "essential layout main pane width share front window", icon: "󰡎" },
