...
// Search index for the settings panel.
//
...
QtObject {
    ...
    readonly property int pageWidgets: 2
    readonly property int pageDock: 3
    readonly property int pageNet: 4
    readonly property int pageGame: 5
    ...
    readonly property var entries: [
        ...
        // ── Widgets ───────────────────────────────────────────────────
        { key: "widgets",       label: "Desktop widgets",    page: 2, words: "widget clock date media calendar" },
        { key: "widgetsShown",  label: "Show desktop widgets", page: 2, words: "widget hide desktop column" },
        { key: "glyphEnabled",  label: "Glyph Matrix",        page: 2, words: "glyph matrix disc nothing phone toy" },
        { key: "glyphSize",     label: "Glyph Matrix size",   page: 2, words: "glyph size diameter disc" },
        { key: "glyphAbove",    label: "Glyph Matrix above windows", page: 2, words: "glyph layer overlay desktop" },
        { key: "glyphPos",      label: "Glyph Matrix position", page: 2, words: "glyph move drag recenter" },
        { key: "glyphToys",     label: "Glyph Matrix toys",   page: 2, words: "glyph clock battery dice timer visualizer cava pendulum counter" },
        ...
        // ── Network ───────────────────────────────────────────────────
        { key: "wifi",      label: "Wi-Fi",     page: 4, words: "wifi wireless network internet" },
